...
{
    $sql = "INSERT INTO taikhoan(ho_ten,email,mat_khau,vai_tro) VALUES(?,?,?,?,)";
    pdo_execute($sql, $ho_ten, $mat_khau, $email, $vai_tro);
}

function khachHang_update($ho_ten, $mat_khau, $email, $vai_tro, $ma_kh)
{
    $sql = "UPDATE taikhoan SET ho_ten=? , mat_khau=?, email=? , vai_tro=? WHERE ma_tk=?";
